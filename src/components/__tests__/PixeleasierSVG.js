import PixeleasierSVG from '../PixeleasierSVG';
...
describe('PixeleasierSVG', () => {
	let component;

	it('should render a PixeleasierSVG empty component', () => {
		component = new PixeleasierSVG();

		expect(component.render()).toMatchSnapshot();
	});

	it('should render a PixeleasierSVG component with size 5px', () => {
		component = new PixeleasierSVG(arrFinn, 5, 'px');
