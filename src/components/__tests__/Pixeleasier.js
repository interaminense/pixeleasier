...
describe('Pixeleasier', () => {
	let component;

	it('should render a Pixeleasier empty component', () => {
		component = new Pixeleasier();

		expect(component.render()).toMatchSnapshot();
	});

	it('should render a Pixeleasier component with size 5px', () => {
		component = new Pixeleasier(arrFinn, 5, 'px');
